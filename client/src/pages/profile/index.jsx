    ...
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-[80vw] md:w-max ">
        ...
        <div className="grid grid-cols-2">
            ...
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {
                image ? (
                  ...
                  <div className={` uppercase h-32 w-32 md:w-48 text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(
                    selectedColor
                    )}`}
                  >
                    {firstName
          ...
          <div className="w-full">
              <Button className="h-16 w-full bg-purple-700 hover:bg-purple-900 translate-all duration-all duration-300"
              onClick={saveChanges}>
                Save Changes 
              </Button> 
          </div>
